...
for var in global_settings.variables.keys():
    ...
    for season in seasons:
        plot_configs[var + "-" + season] = [template.clone(var, task_name="seasonal_mean", file=var + "-" + season + ".nc")]
        ...
        plot_configs[var + "-reference-" + season] = [template.clone(var, task_name="seasonal_mean", file=var + "-reference-" + season + ".nc")]
