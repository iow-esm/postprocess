...
results_dir = create_results_dir(out_dir, from_date, to_date)
...
for var in variables.keys():	
    for names, numbers in seasons.items():
        ...
        os.system("cdo -timmean -selmon," + numbers + seldate +  " -cat \'" + files[var] + "\' " + results_dir + "/" + var + "-" + names + ".nc")
        ...
        for p in percentiles:
            os.system("cdo timpctl," + p + " -selmon," + numbers + seldate + " -cat \'" + files[var] + "\' " + results_dir + "/minfile.nc " + results_dir + "/maxfile.nc " + results_dir + "/" + var + "-" + names + "-PCTL_" + p + ".nc")
